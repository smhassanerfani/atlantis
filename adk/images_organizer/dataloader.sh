...
for i in "${!sdirs[@]}"; do 
	...
	rsync --files-from=${odir}/${sdir}/images_train_images.txt ${odir}/${sdir}/images ${ddir}/images/train/${sdir};
	rsync --files-from=${odir}/${sdir}/images_test_images.txt ${odir}/${sdir}/images ${ddir}/images/test/${sdir};
	rsync --files-from=${odir}/${sdir}/images_val_images.txt ${odir}/${sdir}/images ${ddir}/images/val/${sdir};
	rsync --files-from=${odir}/${sdir}/masks_train_images.txt ${odir}/${sdir}/masks ${ddir}/masks/train/${sdir};
	rsync --files-from=${odir}/${sdir}/masks_test_images.txt ${odir}/${sdir}/masks ${ddir}/masks/test/${sdir};
	rsync --files-from=${odir}/${sdir}/masks_val_images.txt ${odir}/${sdir}/masks ${ddir}/masks/val/${sdir};
done
