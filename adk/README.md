...
## `waterbody_extractor/`
This python script developed to derive [ATeX](https://github.com/smhassanerfani/atex) patches from ATLANTIS. `pyscript.py` first extracts water part from images using ground-truth masks based on waterbodies’ coordination, then the outputs are cropped 32×32 to create ATeX patches.
