...
from AtlantisLoader import ATEXDataSet
...
MODEL = 'ResNet152'
NUM_CLASSES = 15
SNAPSHOT_DIR = './snapshots/atex'
DATA_DIRECTORY = './data/atex'
BATCH_SIZE = 64
NUM_WORKERS = 64
...
NUM_EPOCHS = 30
POWER = 0.9
RESTORE_FROM = './model/resnet152-imagenet.pth'
...
def main():
    ...
    trainloader = data.DataLoader(
            ATEXDataSet(args.data_dir, split='train', joint_transform=train_joint_transform),
    ...
    for epoch in range(args.num_epochs):
        ...
        valloader = data.DataLoader(
            ATEXDataSet(args.data_dir, split='test', padding_size=args.padding_size),
